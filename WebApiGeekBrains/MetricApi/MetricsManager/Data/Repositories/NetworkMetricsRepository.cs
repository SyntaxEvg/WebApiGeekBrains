...
namespace MetricsManager.DataAccessLayer.Repositories
{
    public class NetworkMetricsRepository : INetworkMetricsManagerRepository
    {
        ...
        public ICollection<NetworkMetric> GetByTimePeriod(DateTimeOffset from, DateTimeOffset to)
        {
            using var connection = new SQLiteConnection(_connectionString);
            return connection
                .Query<NetworkMetric>(
        ...
        public ICollection<NetworkMetric> GetByTimePeriodFromAgent(DateTimeOffset from, DateTimeOffset to, int agentId)
        {
            using var connection = new SQLiteConnection(_connectionString);
            return connection
                .Query<NetworkMetric>(
