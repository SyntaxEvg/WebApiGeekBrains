...
{
    public partial class Hdd : System.Windows.Controls.UserControl, INotifyPropertyChanged
    {
        ...
        public SeriesCollection ColumnSeriesValues
        {
                ...
                return new SeriesCollection
            {
                    new ColumnSeries
                    {
                        Values = new ChartValues<double> { 70, 20, 30, 40, 50, 60, 70, 80, 90, 100 }
                    }
                };
            }
            set
        ...
        {
            var metrics = MainWindow._hddModel!.Metrics;
